...
for train_index, val_index in rkf.split(X_normalized):
    ...
    quantized_I1 = InputQuantizationLayer(min_val=overall_new_min_0p1, 
                                          max_val=overall_new_max_99p9, 
                                          name="IQ1_quant")(I1)
    quantized_I2 = InputQuantizationLayer(min_val=overall_new_min_0p1, 
                                          max_val=overall_new_max_99p9, 
                                          name="IQ2_quant")(I2)
